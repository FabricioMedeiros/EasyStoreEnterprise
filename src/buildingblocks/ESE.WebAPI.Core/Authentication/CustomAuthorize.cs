...
namespace ESE.WebAPI.Core.Authentication
{
    ...
    {
        public static bool CheckUserClaim(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequirementClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!CustomAuthorization.CheckUserClaim(context.HttpContext, _claim.Type, _claim.Value))
            {
